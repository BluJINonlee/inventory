...
<html>
	...
	<body onload="selectType();ifOtherMonitor();ifOtherPC()">
		<h1><u>567 W. Lake St. Inventory</u></h1>
		
		<form name="scanItem" id="scanItem" onsubmit="return onEnter()" action="updateLake.php" method="POST">
		  
		  <input type='text' name='cube' id='cube' placeholder='Cube#'/>
