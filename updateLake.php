...
$model;
$site = 'LAK';
$location = ifNull($_REQUEST["cube"]);
$firstName = ifNull($_REQUEST["firstName"]);
$lastName = ifNull($_REQUEST["lastName"]);
...
if ($_REQUEST["scanType"] != "pc"){
	...
	$sql = "INSERT INTO $table (asset, serial, model, site, location, lastName, firstName) VALUES ($asset, $serial, '$model', '$site', '$location',$lastName,$firstName)";
